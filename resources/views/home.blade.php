<x-main-layout pageTitle="Quiz de Países e Capitais">
            ...
            <div class="col-4 text-center">
                <form action="{{ route('prepare_game') }}" method="post">
                    ...
                    <div class="mt-3 mb-5">
                        ...
                        <input class="form-control form-control-lg text-center" type="number" name="total_questions" id="total_questions" value="" placeholder="Digite um número">
